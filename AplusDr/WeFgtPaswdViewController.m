...
#import "WeFgtInpViewController.h"

@interface WeFgtPaswdViewController ()

@end

@implementation WeFgtPaswdViewController
...
- (void)api_user_sendVerificationCode {
    ...
    [WeAppDelegate postToServerWithField:@"user" action:@"forgetPassword"
                              parameters:@{
