...
#define yijiarenShareURL(field) [NSString stringWithFormat:@"%@/web/viewFunding?fundingId=%@", yijiarenServer, field]
...
#define We_background_cell_general UIColorFromRGB(255, 255, 255, 0.9)
